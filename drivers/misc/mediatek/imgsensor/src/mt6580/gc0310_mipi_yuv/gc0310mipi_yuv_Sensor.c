...
UINT32 GC0310_MIPI_SetVideoFrameRate( UINT32 FeatureData32)
{
	if(FeatureData32 == 30)
	{
        ...
        GC0310_write_cmos_sensor(0x27,0x01); //30fps 
        GC0310_write_cmos_sensor(0x28,0xce); 
        GC0310_write_cmos_sensor(0x29,0x01); //30fps 
        GC0310_write_cmos_sensor(0x2a,0xce); 
        GC0310_write_cmos_sensor(0x2b,0x01); //30fps 
        GC0310_write_cmos_sensor(0x2c,0xce); 
        GC0310_write_cmos_sensor(0x2d,0x01); //30fps 
        GC0310_write_cmos_sensor(0x2e,0xce); // 
        GC0310_write_cmos_sensor(0xfe,0x00);
	}
	else if(FeatureData32 == 20)
	{
        ...
        GC0310_write_cmos_sensor(0x2d,0x03); //8fps 
