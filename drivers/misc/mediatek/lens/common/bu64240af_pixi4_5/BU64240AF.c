...
#define AF_DRVNAME "BU64240AF_DRV"
...
static int s4AF_ReadReg(unsigned short *a_pu2Result)
{
	...
	*a_pu2Result = (((u16)(pBuff[0] & 0x03)) << 8) + pBuff[1];  //2015
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	LOG_INF("2015 add move [curr] %ld\n", g_u4CurrPosition);
	LOG_INF("2015 add move [Targ] %ld\n", g_u4TargetPosition);
...
/* ////////////////////////////////////////////////////////////// */
long BU64240AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int BU64240AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void BU64240AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
