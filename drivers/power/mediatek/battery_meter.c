...
void oam_run(void)
{
	...
	if(oam_r_1)
		...
		oam_i_1 = (((oam_v_ocv_1 - vol_bat) * 1000) * 10);
		printk("oam_run: Division by zero at line %i !!!!\n", __LINE__);
	}
	if(oam_r_2)
		oam_i_2 = (((oam_v_ocv_2 - vol_bat) * 1000) * 10) / oam_r_2;	/* 0.1mA */
	else {
		oam_i_2 = (((oam_v_ocv_2 - vol_bat) * 1000) * 10);
		printk("oam_run: Division by zero at line %i !!!!\n", __LINE__);
	}
	...
	if(!gFG_BATT_CAPACITY_aging) {
		printk("oam_run: Attempt to division by zero (gFG_BATT_CAPACITY_aging = 0) !!!!\n");
		gFG_BATT_CAPACITY_aging = 1200;
		printk("oam_run: New value gFG_BATT_CAPACITY_aging = 1200\n");
	}
